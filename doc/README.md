...
You need the Qt4 run-time libraries to run Prototanium-Qt. On Debian or Ubuntu:
...
Drag Prototanium-Qt to your applications folder, and then run Prototanium-Qt.
