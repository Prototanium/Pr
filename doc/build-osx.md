...
bitcoind/bitcoin-cli binaries are not included in the Prototanium-Qt.app bundle.

If you are building `bitcoind` or `Prototanium-Qt` for others, your build machine should be set up
...
Once dependencies are compiled, see [doc/release-process.md](release-process.md) for how the Prototanium-Qt.app
