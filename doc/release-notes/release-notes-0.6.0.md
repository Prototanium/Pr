...
Prototanium-Qt can display and save QR codes for sending
...
versions of Prototanium-Qt/bitcoind.
...
Prototanium-Qt's initial splash screen
...
opening/launching Prototanium-Qt is available only on Linux,
and only if you configure your desktop to launch
Prototanium-Qt. All platforms support dragging and dropping
bitcoin: URIs onto the Prototanium-Qt window to start
payment.
...
It is expected that future releases of Prototanium-Qt
