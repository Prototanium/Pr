    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Prototanium") + " ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Prototanium Client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Prototanium network", "", count));
}
...
{
    QString strTitle = tr("Prototanium"); // default title
